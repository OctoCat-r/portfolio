...
const About = () => {
  return (
    <>
      <motion.div>
        <br />
        <p className="font-serif... text-5xl px-4">Introduction</p>
        {/* <h2 className={styles.sectionHeadText}>Overview.</h2> */}
      </motion.div>
      <motion.p
        variants={fadeIn("", "", 0.1, 1)}
        className="mt-4 text-secondary text-[19px] max-w-3xl leading-[30px] px-4"
      >
        I'm a skilled software developer with experience in TypeScript and
        JavaScript, and expertise in frameworks like React, Node.js, Three.js,
        and many more. I'm a quick learner and collaborate closely with clients
